...
<div class=" bg-gray-900 flex flex-col items-center justify-center mt-5 mx-4 rounded-lg py-10 px-5 md:min-w-xl md:mx-auto">
    <form method="post">
        ...
        <div class=" block mb-4">
            <label for="" class="text-white font-light font-Outfit font-sm mb-4">Password</label>
        ...
        <div class=" block mb-4">
            <label for="" class="text-white font-light font-Outfit  font-sm mb-2">Nombre completo</label>
        ...
        <div class=" block mb-4">
            <label for="" class=" text-white font-light font-Outfit font-sm mb-2">Tipo</label>
            <select v-model="tipo" class="bg-gray-300 h-11 w-full appearance-none rounded-lg border border-gray-300/70 font-light font-Outfit  px-4 p-2 pr-11 text-sm text-gray-800/70 shadow-theme-xs placeholder:text-gray-400/70 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 mt-4  ">
